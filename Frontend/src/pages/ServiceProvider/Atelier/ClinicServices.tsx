             ...
             {isAdding && (
               <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="bg-white rounded-[3.5rem] border-2 border-caramel/20 p-12 shadow-2xl relative">
                  ...
                  <div className="grid lg:grid-cols-2 gap-12">
                     ...
                     <div className="space-y-10">
                        <div className="space-y-3">
                           <label className="text-[10px] font-black uppercase tracking-widest text-muted pl-4 italic">Service Specialties (Features)</label>
                        ...
                        <div className="space-y-4">
                           <label className="text-[10px] font-black uppercase tracking-widest text-muted pl-4 italic">Primary Visual Asset (Single Image)</label>
                           <div className="grid grid-cols-2 gap-4">
