const Hero = () => {
  return (
    <section className="relative min-h-[85vh] flex items-center bg-gradient-to-r from-warm via-warm to-cream pt-20 px-6 lg:px-24 overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full">
        <div className="z-10 animate-in fade-in slide-in-from-left duration-700">
          <div className="inline-flex items-center gap-2 bg-white border border-sand px-4 py-1.5 rounded-full mb-8">
          ...
          <h1 className="font-serif text-[64px] lg:text-[88px] leading-[0.95] font-extrabold text-gray-900 mb-8 tracking-tight">
            Cherish <br />
            every small <br />
            <span className="text-brown italic font-normal">moment</span>
          </h1>
          ...
          <div className="flex flex-wrap items-center gap-8">
            <button className="bg-brown text-white px-10 py-4 rounded-full font-bold text-[15px] hover:bg-brown-dark transition-all duration-300 shadow-xl shadow-caramel/70 group">
              Explore Now →
            </button>
        ...
        <div className="relative flex justify-center lg:justify-end animate-in fade-in slide-in-from-right duration-1000 lg:pr-12">
          <div className="relative w-full max-w-[500px] aspect-[4/5.2]">
            ...
            <div className="absolute left-[-70px] top-[25%] flex flex-col gap-4 z-20 hidden md:flex">
              <div className="bg-white p-6 rounded-[32px] shadow-2xl shadow-black/5 border border-sand w-[140px] animate-in fade-in slide-in-from-left duration-700 delay-300">
              ...
              <div className="bg-white p-6 rounded-[32px] shadow-2xl shadow-black/5 border border-sand w-[140px] animate-in fade-in slide-in-from-left duration-700 delay-500">
            ...
            <div className="absolute bottom-10 left-[-30px] w-[320px] z-30 animate-in fade-in slide-in-from-bottom duration-1000 delay-700">
              <div className="bg-white p-5 rounded-[32px] shadow-2xl shadow-black/10 flex items-center gap-4 border border-sand">
      ...
      <div className="absolute top-[-10%] right-[-5%] w-[600px] h-[600px] bg-sand rounded-full blur-[120px] -z-10" />
    </section>
  );
};
